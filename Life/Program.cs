...
namespace cli_life
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            configuration.LoadConfig("C:\\Рыба\\source\\repos\\mod-task04-life\\Life\\Configuration.json");
            Reset(configuration);
            configuration.LoadState(board, "C:\\Рыба\\source\\repos\\mod-task04-life\\Life\\save.txt");
            while (true)
            {
                Console.Clear();
                Render();
                configuration.SaveState(board, "C:\\Рыба\\source\\repos\\mod-task04-life\\Life\\save.txt");
                board.Advance();
                Thread.Sleep(1000);
            }
        }
